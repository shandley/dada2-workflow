...
if (taxonomy_methods$IDTAXA) {
  ...
  if (!requireNamespace("DECIPHER", quietly = TRUE)) {
    ...
    # Download/prepare SILVA/RDP training set for IDTAXA
    # We can reuse the SILVA database files already downloaded
    if (exists("silva_files") && file.exists(silva_files$train)) {
      cat("Using existing SILVA files for IDTAXA...\n")
      ...
      cat("SILVA database files required for IDTAXA were not found. Please run the SILVA taxonomy method first.\n")
    }
  }
}
```
