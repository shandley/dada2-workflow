  ...
  if (!requireNamespace("DECIPHER", quietly = TRUE)) {
    ...
    if (!is.null(idtaxa_train)) {
      ...
      if (exists("hw_caps") && hw_caps$apple_silicon) {
        ...
        idtaxa_threshold <- 60 # Slightly higher threshold for more precision on M-series
      } else if (exists("hw_caps") && hw_caps$has_gpu) {
        ...
        idtaxa_threshold <- 50 # Default confidence threshold
      }
      ...
      tryCatch({
        ...
        for (i in 1:n_asv) {
          ...
          # Map to standard taxonomy levels
