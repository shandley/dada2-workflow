...
track <- cbind(
  # Input reads
  out[rownames(out) %in% names(derepFs), "reads.in"],
  # Filtered reads
  out[rownames(out) %in% names(derepFs), "reads.out"],
...
colnames(track) <- c("Input", "Filtered", "Denoised_F", "Denoised_R", "Merged", "NonChimeric")
